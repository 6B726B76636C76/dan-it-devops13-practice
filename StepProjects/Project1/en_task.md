...
Use source code from ([repo](https://gitlab.com/dan-it/groups/devops_soft/-/tree/main/forStep1/PetClinic?ref_type=heads))
...
Subtask I - Infrastructure
    ...
    Describe ([two virtual machines](https://developer.hashicorp.com/vagrant/docs/multi-machine)) using Vagrantfile for deployment of the application (codename APP_VM) and the database (codename DB_VM)
...
Subtask II - Database
    ...
    Use any ([provisioning script](https://developer.hashicorp.com/vagrant/docs/provisioning/basic_usage)) that you created to install MySQL and any dependency on DB_VM
